-- Permite salvar contratos com entrada vencida sem violar due_date >= issue_date.
-- O lançamento financeiro não liquidado acompanha a data de vencimento histórica.
...
begin
  ...
  update public.financial_entries e
     set issue_date = least(e.issue_date, p_entry_due_on),
         due_date = p_entry_due_on
