-- Persist the generated internal document number and editable tags on the payout.
alter table public.commission_payout_settlements
  add column document_number text,
  add column tags text;

drop function if exists public.pay_commission(uuid, uuid, date, date, uuid[], date, date, uuid, public.financial_payment_method, text, text);
