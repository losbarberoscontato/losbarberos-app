    ...
    <div className={styles.grid}>
      <Panel title="Regras da barbearia" description="Valores usados para novos agendamentos" className={styles.span7}>
        <form className={styles.form} onSubmit={saveOrganization}>
          ...
          <Field label="Intervalo dos slots"><select name="slot_interval_minutes" defaultValue={props.organization.slot_interval_minutes}>{[5, 10, 15, 20, 30, 60].map((value) => <option key={value} value={value}>{value} minutos</option>)}</select></Field>
