...
export function humanizeError(error: unknown) {
  ...
  const dictionary: Array<[RegExp, string]> = [
    ...
    [/module contract acceptance required/i, "Aceite o aditivo contratual do módulo antes de ativá-lo."],
    [/customer already has this plan|customer already has an active subscription/i, "Este cliente já possui uma assinatura ativa."],
