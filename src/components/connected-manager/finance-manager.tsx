...
export function FinanceManager(props: Props) {
  ...
  return <div className={styles.stack}>
    ...
    <Panel title="Conferência de Caixa" description="Caixas abertos devem ser conciliados por esta aba.">
      <section className={styles.list} aria-label="Caixas diários dos Barbeiros"><h3>Caixas diários dos Barbeiros</h3><BarberCashSessionReconciliation sessions={props.barberCashSessions} receipts={props.barberCashReceipts} financialAccounts={props.financialAccounts} barberNames={props.barberNames} setMessage={setMessage} onSaved={() => router.refresh()} /></section>
