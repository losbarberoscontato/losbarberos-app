...
export type BarberProjectInternalService = { id: string; engagement_id: string | null; internal_card_id?: string | null; service_name: string; barber_id: string; commission_cents: number; delivery_on: string | null; status: "OPEN" | "READY_FOR_REVIEW" | "COMPLETED" | string; review_requested_at?: string | null; review_requested_by?: string | null };
