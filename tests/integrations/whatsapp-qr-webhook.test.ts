...
describe("Evolution QR Web webhook", () => {
  it("valida o segredo do header antes de atualizar o estado tenant-safe", () => {
    ...
    expect(source).toContain("x-evolution-webhook-secret");
    expect(source).toContain("verifySharedSecretHeader");
    expect(source).not.toContain("x-evolution-signature");
